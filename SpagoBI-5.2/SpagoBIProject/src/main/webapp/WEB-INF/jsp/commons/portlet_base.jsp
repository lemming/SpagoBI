...
<%-- <script type="text/javascript" src="<%=urlBuilder.getResourceLink(request, "js/lib/ext-2.0.1/locale/ext-lang-" + (locale != null ? locale.getLanguage() : GeneralUtilities.getDefaultLocale().getLanguage()) + ".js")%>"></script> --%>
<script type="text/javascript" src="<%=urlBuilder.getResourceLink(request, "js/lib/ext-2.0.1/locale/ext-lang-" + (locale != null ? locale.getLanguage() : GeneralUtilities.getDefaultLocale().getLanguage()) + ".js")%>"></script>
